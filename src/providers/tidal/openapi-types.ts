/**
 * Auto-generated from Tidal Open API v2 spec.
 *
 * Source:    https://tidal-music.github.io/tidal-api-reference/tidal-api-oas.json
 * Generator: openapi-typescript v7.13.0
 * Regenerate: `npm run gen:tidal-types`
 *
 * Do not edit by hand. Any code in src/providers/tidal/** or src/match/** that
 * touches Tidal request URLs or response shapes MUST import from this file
 * rather than redeclaring interfaces. See `.harness/context_summary.md`
 * Cross-Cutting Concerns for the project rule.
 */
