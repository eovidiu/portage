# sync-notifications Specification

## Purpose
Push sync-run outcomes and abandoned-run alerts to an ntfy topic so the operator hears about every run and every problem without polling. Created by archiving change f-029-ntfy-notifications.
## Requirements
